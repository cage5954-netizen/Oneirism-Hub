...
import protagonistImg from '../assets/images/Protagonist.jpg';
import forgerImg from '../assets/images/The Forger.png';
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        {CHARACTERS.map((char, index) => {
          // ✅ Pick the correct image based on name; fall back to char.image if present
          const imageSrc =
            char.name === 'The Protagonist'
              ? protagonistImg
              : char.name === 'The Forger'
              ? forgerImg
              : char.name === 'The Fireman'
              ? firemanImg
              : char.image;
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 w-full p-10 z-30 flex flex-col justify-end h-full">
                <div className="transform translate-y-8 group-hover:translate-y-0 transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)]">
                  ...
                  <h2 className="text-4xl font-cinematic font-bold text-white mb-6 uppercase tracking-wider">
                    {char.name}
                  </h2>
